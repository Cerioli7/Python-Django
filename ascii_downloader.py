...
def download_ascii():
    ...
    textwidtget = tk.Text()
    textwidtget.insert(tk.END, text_response)
    textwidtget.grid(row=3, column=0, sticky="WE", padx=10, pady=10)
...
welcome_label = tk.Label(window,
                         text="Welcome! Aggiungi un parola o una frase da scaricare:",
                         font=("Arial", 15))
